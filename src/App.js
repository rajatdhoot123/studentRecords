        ...
        <div className="App">
          <header className="sticky-top row p-3">
            <div className="col-md-8 my-2">
              <input className="form-control" type="search" onChange={this.handleSearch.bind(this)} placeholder="Search" aria-label="Search" />
            </div>
            <div className="col-md-2 my-2">
              <button className="btn btn-primary btn-block" onClick={this.toggleSort.bind(this)}>Sort by Name</button>
            </div>
            <div className="col-md-2 my-2">
